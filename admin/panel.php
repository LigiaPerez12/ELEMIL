...
<!-- DataTables -->
  ...
  <link rel="stylesheet" href="https://cdn.datacsstables.net/responsive/2.4.0/css/responsive.dataTables.min.css">
  <link rel="stylesheet" href="css/editor.dataTables.min.css">

  <link rel="stylesheet" href="dist/js/pages/dashboard.js">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="dist/img/elemil.png" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="#" class="brand-link" style="background-color:#00394f;">
      <img src="dist/img/elemil.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">ELEMIL WATER</span>
    </a>

    <!-- Sidebar -->
    <div class="sidebar"  style="background-color:#00394f;">
      <!-- Sidebar user panel (optional) -->
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/elemil.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link active">
              <i class="fa fa-shopping-cart nav-icon" arian-hidden="true"></i>
              <p>
                ELEMIL-WATER
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
              <a href="panel.php?modulo=usuarios" class="nav-link <?php echo ($modulo=="usuarios" 
              || $modulo=="crearUsuario" || $modulo=="editarUsuario" )?" active ":" "; ?>">
